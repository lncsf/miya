  ...
  <div class="floor">
             ...
             <div class="floor-one">
               ...
               <div  class="floor-one-ul">
                 <ul >
                   <li>
                     <img src="../../assets/img/products/sm/1_sm.png" alt=""/>
                     <p>德国爱他美 Aptamil 婴幼儿配方奶粉1+段12m+800g *4罐（安心罐）</p>
                     <p>¥535</p>
                   </li>
                   <li>
                     <img src="../../assets/img/products/sm/2_sm.png" alt=""/>
                     <p>新西兰原装 a2 【品牌授权】PLATINUM婴儿奶粉3段12~36M 900g*2罐</p>
                     <p>¥450</p>
                   </li>
                   <li>
                     <img src="../../assets/img/products/sm/3_sm.png" alt=""/>
                     <p>德国爱他美 Aptamil 爱他美婴儿配方奶粉3段10~12M 800g*2罐</p>
                     <p>¥320</p>
                   </li>
                   <li>
                     <img src="../../assets/img/products/sm/6_sm.png" alt=""/>
                     <p>荷兰牛栏 Nutrilon 婴幼儿奶粉4段12M+800g*4罐</p>
                     <p>¥556</p>
                   </li>
                   <li>
                     <img src="../../assets/img/products/sm/8_sm.png" alt=""/>
                     <p>新西兰原装 a2 【品牌授权】PLATINUM婴儿奶粉2段6~12M 900g*2罐</p>
                     <p>¥456</p>
                   </li>
                   <li>
                     <img src="../../assets/img/products/sm/9_sm.png" alt=""/>
                     <p>荷兰牛栏 Nutrilon 婴幼儿奶粉5段24M+800g*4罐</p>
                     <p>¥432</p>
                   </li>
                   <li>
                     <img src="../../assets/img/products/sm/10_sm.png" alt=""/>
             ...
             <div class="floor-three">
               ...
               <ul class="floor-three-ul">
                 <li v-for="tmp in lists">
                   <img :src="require('../../assets/'+tmp.sm)" alt=""/>
